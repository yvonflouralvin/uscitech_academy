...
export default function TeacherPage(props: PageProps){
        ...
        <div className='border-t border-inherent mt-[15px] pt-[15px] h-full'>
            <div className="flex items-start">
                <div className='flex flex-col flex-1'>
                    <p className='font-semibold text-[20px] m-0'>Professeurs</p>
                    {/* <p className='text-gray-500 font-light m-0 text-[13px]'>27 employés</p> */}
                </div>
                <div>
                    <Link href="/apps/uscitech_academy/teachers/create" className='duration-300 flex items-center gap-[2px] text-[13px] text-white font-bold cursor-pointer rounded py-[5px] px-[15px] bg-primary/80 hover:bg-primary'>
